...
void RainbowNew::update(ofImage &depthFrame, ofImage &userFrame, ofFloatColor color, float _threshold, float expansion, glm::vec2 expansionVector, float boostUser) {
	reloadShaders();
